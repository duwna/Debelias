...
data class Settings(
    ...
    companion object {
        ...
        fun fromDto(dto: AppSettingsDto) = Settings(
            ...
            successWordPoints = dto.successWordPoints.takeIf { it != 0 }
                ?: DEFAULT_SUCCESS_WORD_POINTS,
            failureWordPoints = dto.failureWordPoints.takeIf { it != 0 }
                ?: DEFAULT_FAILURE_WORD_POINTS
        )
    }
}
...
data class AppSettingsDto(
    ...
    val successWordPoints: Int = 2,
    val failureWordPoints: Int = 1
)